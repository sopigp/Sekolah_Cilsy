...
WebUI.setText(findTestObject('Manual/OrangeHRM/input_add_employee_confirmpassword'), add_employee_password)

WebUI.click(findTestObject('Manual/OrangeHRM/btn_add_employee_save'))

WebUI.verifyElementText(findTestObject('Manual/OrangeHRM/validation_add_employee_password'), 'Should have at least 8 characters')
